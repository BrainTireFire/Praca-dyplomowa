...
export default function ShortRestModalCharacter({onCloseModal}: {onCloseModal: () => void}) {
  ...
  return (
    <div style={{display: "flex", flexDirection: "column"}}>
      ...
      <Container>
        {diceFields.map(field => (
          <div key={field} style={{ display: 'contents' }}>
            ...
            <Button size="small" onClick={() => updateDice(field, -1)} disabled={isButtonDisabled(field, -1)}>-</Button>
      ...
      <Button style={{marginTop: '5px'}} onClick={handleSendHitDice}>Confirm</Button>
    </div>
  );
}
