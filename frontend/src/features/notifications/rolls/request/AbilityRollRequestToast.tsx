...
interface AbilityRollRequestToastProps {
  message: string;
  characterId: string;
...
const AbilityRollRequestToast: React.FC<AbilityRollRequestToastProps> = ({
  message,
  characterId,
  characterName,
  ability
  ...
  const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    queryParams.set("characterAbilityRoll", `${characterId}:${ability}`);
  ...
  return (
      <ToastWrapper onClick={handleClick}>
        ...
        <ToastContent>
          <ToastHeader>{ability} roll requested!</ToastHeader>
...
export default AbilityRollRequestToast;
