...
interface SavingThrowRollRequestToastProps {
  message: string;
  characterId: string;
...
const SavingThrowRollRequestToast: React.FC<SavingThrowRollRequestToastProps> = ({
  message,
  characterId,
  characterName,
  ability
  ...
  const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    queryParams.set("characterSavingThrowRoll", `${characterId}:${ability}`);
  ...
  return (
      <ToastWrapper onClick={handleClick}>
        ...
        <ToastContent>
          <ToastHeader>{ability} Saving Throw roll requested!</ToastHeader>
...
export default SavingThrowRollRequestToast;
