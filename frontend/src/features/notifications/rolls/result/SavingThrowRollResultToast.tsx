...
interface SavingThrowRollResultToastProps {
  message: string;
...
const AbilityRollResultToast: React.FC<SavingThrowRollResultToastProps> = ({
  message,
  characterName,
  ability,
  roll
  ...
  return (
      <ToastWrapper>
        ...
        <ToastContent>
          <ToastHeader>{ability} Saving Throw roll result</ToastHeader>
...
export default AbilityRollResultToast;
