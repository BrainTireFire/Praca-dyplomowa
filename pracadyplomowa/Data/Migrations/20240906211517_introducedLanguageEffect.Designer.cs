...
namespace pracadyplomowa.Data.Migrations
{
    ...
    [Migration("20240906211517_introducedLanguageEffect")]
    partial class introducedLanguageEffect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChoiceGroupUsageEffectGroup", b =>
                {
                    b.Property<int>("R_EffectGroupsGrantedId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("R_GrantedThroughId")
                        .HasColumnType("INTEGER");

                    b.HasKey("R_EffectGroupsGrantedId", "R_GrantedThroughId");

                    b.HasIndex("R_GrantedThroughId");

                    b.ToTable("ChoiceGroupUsageEffectGroup");
                });
            ...
            modelBuilder.Entity("ChoiceGroupUsagePower", b =>
                {
                    ...
                    b.Property<int>("R_PowersGrantedId")
                        .HasColumnType("INTEGER");

                    b.HasKey("R_GrantedThroughId", "R_PowersGrantedId");

                    b.HasIndex("R_PowersGrantedId");
            ...
            modelBuilder.Entity("ChoiceGroupUsageEffectGroup", b =>
                {
                    b.HasOne("pracadyplomowa.Models.Entities.Powers.EffectGroup", null)
                        .WithMany()
                        .HasForeignKey("R_EffectGroupsGrantedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ChoiceGroupUsagePower", b =>
                {
                    ...
                    b.HasOne("pracadyplomowa.Models.Entities.Powers.Power", null)
                        .WithMany()
                        .HasForeignKey("R_PowersGrantedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
