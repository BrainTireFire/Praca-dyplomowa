...
namespace pracadyplomowa.Data.Migrations
{
    ...
    [Migration("20240909184435_removedComplexTypes")]
    partial class removedComplexTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Characters.ClassLevel", b =>
                {
                    ...
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "HitDie", b1 =>
                        {
                            ...
                            b1.HasKey("ClassLevelId");

                            b1.ToTable("ClassLevels");
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Characters.Character", b =>
                {
                    ...
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "UsedHitDice", b1 =>
                        {
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.AbilityEffectBlueprint", b =>
                {
                    ...
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "DiceSet", b1 =>
                        {
                            b1.Property<int>("AbilityEffectBlueprintId")
                                .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.ArmorClassEffectBlueprint", b =>
                {
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "DiceSet", b1 =>
                        {
                            b1.Property<int>("ArmorClassEffectBlueprintId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("ArmorClassEffectBlueprintId");

                            b1.ToTable("EffectBlueprints");

                            b1.WithOwner()
                                .HasForeignKey("ArmorClassEffectBlueprintId");
                        });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.HealingEffectBlueprint", b =>
                {
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "DiceSet", b1 =>
                        {
                            b1.Property<int>("HealingEffectBlueprintId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("HealingEffectBlueprintId");

                            b1.ToTable("EffectBlueprints");

                            b1.WithOwner()
                                .HasForeignKey("HealingEffectBlueprintId");
                        });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.IniativeEffectBlueprint", b =>
                {
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "DiceSet", b1 =>
                        {
                            b1.Property<int>("IniativeEffectBlueprintId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("IniativeEffectBlueprintId");

                            b1.ToTable("EffectBlueprints");

                            b1.WithOwner()
                                .HasForeignKey("IniativeEffectBlueprintId");
                        });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.MagicEffectBlueprint", b =>
                {
                    b.OwnsOne("pracadyplomowa.Models.Entities.Characters.DiceSet", "DiceSet", b1 =>
                        {
                            b1.Property<int>("MagicEffectBlueprintId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("MagicEffectBlueprintId");

                            b1.ToTable("EffectBlueprints");

                            b1.WithOwner()
                                .HasForeignKey("MagicEffectBlueprintId");
                        });
