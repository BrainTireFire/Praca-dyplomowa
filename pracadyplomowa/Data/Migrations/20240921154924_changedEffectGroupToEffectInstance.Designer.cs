...
namespace pracadyplomowa.Data.Migrations
{
    ...
    [Migration("20240921154924_changedEffectGroupToEffectInstance")]
    partial class changedEffectGroupToEffectInstance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChoiceGroupUsageEffectInstance", b =>
                {
                    b.Property<int>("R_EffectsGrantedId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("R_GrantedThroughId")
                        .HasColumnType("INTEGER");

                    b.HasKey("R_EffectsGrantedId", "R_GrantedThroughId");

                    b.HasIndex("R_GrantedThroughId");

                    b.ToTable("ChoiceGroupUsageEffectInstance");
                });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.IniativeEffectBlueprint", b =>
                {
                    ...
                    b.ToTable("EffectBlueprints", t =>
                        {
                            t.Property("DiceSetId")
                                .HasColumnName("IniativeEffectBlueprint_DiceSetId");
                        });
            ...
            modelBuilder.Entity("ChoiceGroupUsageEffectInstance", b =>
                {
                    b.HasOne("pracadyplomowa.Models.Entities.Powers.EffectInstance", null)
                        .WithMany()
                        .HasForeignKey("R_EffectsGrantedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
