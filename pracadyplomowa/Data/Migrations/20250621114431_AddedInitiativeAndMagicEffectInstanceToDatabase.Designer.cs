...
namespace pracadyplomowa.Data.Migrations
{
    ...
    [Migration("20250621114431_AddedInitiativeAndMagicEffectInstanceToDatabase")]
    partial class AddedInitiativeAndMagicEffectInstanceToDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectBlueprints.MagicEffectInstance", b =>
                {
                    b.HasBaseType("pracadyplomowa.Models.Entities.Powers.ValueEffectInstance");

                    b.HasDiscriminator().HasValue("MagicEffectInstance");
                });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.EffectInstances.InitiativeEffectInstance", b =>
                {
                    b.HasBaseType("pracadyplomowa.Models.Entities.Powers.ValueEffectInstance");

                    b.HasDiscriminator().HasValue("InitiativeEffectInstance");
                });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Characters.DiceSet", b =>
                {
                    ...
                    b.HasOne("pracadyplomowa.Models.Entities.Powers.ValueEffectInstance", "R_ValueEffectInstance")
                        .WithOne("DiceSet")
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Items.Backpack", b =>
                {
                    ...
                    b.OwnsOne("pracadyplomowa.Models.Entities.Items.CoinSack", "CoinSack", b1 =>
                        {
                            b1.Property<int>("BackpackId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("BackpackId");

                            b1.ToTable("Backpacks");

                            b1.WithOwner()
                                .HasForeignKey("BackpackId");
                        });

                    b.Navigation("CoinSack")
                        .IsRequired();
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Items.ItemFamily", b =>
                {
                    b.HasOne("pracadyplomowa.Models.Entities.ObjectWithOwner", null)
                        .WithOne()
                        .HasForeignKey("pracadyplomowa.Models.Entities.Items.ItemFamily", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("pracadyplomowa.Models.Entities.Powers.ImmaterialResourceBlueprint", b =>
                {
                    b.HasOne("pracadyplomowa.Models.Entities.ObjectWithOwner", null)
                        .WithOne()
                        .HasForeignKey("pracadyplomowa.Models.Entities.Powers.ImmaterialResourceBlueprint", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
